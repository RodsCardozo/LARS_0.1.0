...
for i in range(0,n+1):
    nome = (f"temperaturas_transiente_2/resultado_temp_{i}.csv")
...
df_final.to_csv('temperaturas_transiente_2/resultado.csv', index=False)'''

# Plot dos resultados

df_final = pd.read_csv('temperaturas_transiente_2/resultado.csv')
