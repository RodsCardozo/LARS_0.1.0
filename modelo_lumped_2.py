...
face1 = Face(nome = 'Face1', x = 5.0, y = 0.0, z = 0.0, Lx = 0.02, Ly = 0.10, Lz = 0.30, n =  'i' , e = 0.82, a = 0.65,
             rho = 2700.0, k = 200, cp = 920.0)

face2 = Face(nome = 'Face2', x = 0.0, y = 5.0, z = 0.0, Lx = 0.10, Ly = 0.02, Lz = 0.30, n =  'j' , e = 0.82, a = 0.65,
             rho = 2700.0, k = 200, cp = 920.0)

face3 = Face(nome = 'Face3', x = -5.0, y = 0.0, z = 0.0, Lx = 0.02, Ly = 0.10, Lz = 0.30, n =  'i' ,  e = 0.82, a = 0.65,
             rho = 2700.0, k = 200, cp = 920.0)

face4 = Face(nome = 'Face4', x = 0.0, y = -5.0, z = 0.0, Lx = 0.1, Ly = 0.02, Lz = 0.30, n =  'j' ,  e = 0.82, a = 0.65,
             rho = 2700.0, k = 200, cp = 920.0)

face5 = Face(nome = 'Face5', x = 0.0, y = 0.0, z = -15.0, Lx = 0.1, Ly = 0.10, Lz = 0.02, n =  'k' ,  e = 0.82, a = 0.65,
             rho = 2700.0, k = 200, cp = 920.0)

face6 = Face(nome = 'Face6', x = 0.0, y = 0.0, z = 15.0, Lx = 0.1, Ly = 0.10, Lz = 0.02, n =  'k' ,  e = 0.82, a = 0.65,
             rho = 2700.0, k = 200, cp = 920.0)
...
def lumped(calor, fg, area_rad, faces):
    ...
    while n < numero_orbitas:
        ...
        import csv
        with open(f'temperaturas_transiente_4/resultado_temp_{n}.csv', 'w', newline='') as arquivo_csv:
